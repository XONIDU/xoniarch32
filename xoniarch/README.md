...
# Arch Linux Calamares Installer or XONIARCH
...
`git clone https://github.com/arch-linux-calamares-installer/xoniarch-iso`
...
## XONIARCH keys and mirror

Add the XONIARCH keys and Arcolinux mirrors to the packages.x86_64.
...
If you plan to use XONIARCH packages
...
If not on XONIARCH you can install them from AUR.


Install these two packages on your system if you want to include **XONIARCH packages** on the iso

`sudo pacman -S xoniarch-mirrorlist-git xoniarch-keyring`

If not on XONIARCH you can download the package from the xoniarch_repo with sudo pacman -U.

https://github.com/arch-linux-calamares-installer/xoniarch_repo
...
That way we have the XONIARCH repos and Chaotic repos if we do decide to install it after all.
...
When testing out the XONIARCH in virtualbox, you can use the alias 
...
Internet is NOT required for XONIARCH. Calamares is only using the internet to check where you live to put the red dot correctly on the world map (geoip). Calamares will **not download anything**. 
...
## 💛 A Grateful Farewell from the XONIARCH Team

After many years of building, sharing, and learning together, the **XONIARCH project is winding down**.

Although no new updates or packages will be released, we are proud of the knowledge, tools, and community that have grown around XONIARCH.
...
XONIARCH was always built on **Arch Linux**, which is a **rolling release**.  
This means your system can still be installed and updated using standard Arch tools and knowledge.

### Read More

🔗 [A Farewell to the XONIARCH University](https://www.xoniarch.info/a-farewell-to-the-xoniarch-university/)

---

**Thank you for being part of this journey.**  
Your curiosity, passion, and support made XONIARCH what it was.
